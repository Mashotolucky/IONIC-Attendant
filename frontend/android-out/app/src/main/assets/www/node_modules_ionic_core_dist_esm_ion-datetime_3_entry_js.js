...
let Datetime = class {
  ...
  renderTimeOverlay(hoursItems, minutesItems, ampmItems, use24Hour) {
    ...
    return [(0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      "aria-haspopup": "true",
      onClick: function () {
        var _ref = (0,_Users_academy_learners_Documents_group_f_frontend_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
          const {
            popoverRef
          } = _this4;
